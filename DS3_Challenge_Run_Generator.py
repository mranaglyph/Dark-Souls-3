...
armor_param = ['No Armor Allowed', 'Any Armor Allowed', 'Starting Armor Only', 'Armor with Weight >= 10 Only [Per Piece]', 'Armor with Weight <= 3 Only [Per Piece]', 'Fashion Souls (Always Wear a Complete Set)', "Mix n' Match Souls (One Piece of Armor per Set)"]
...
weapon_param2 = ['WA Allowed', 'WA Allowed', 'WA Allowed', 'WA Allowed', 'WA Allowed', 'WA Allowed', 'No WA Allowed', 'Only WA Attack Allowed (If/When Possible)']
